...
import { AddDeckWrapper, DeckTitleInput, SubmitBtn, BtnContainer } from '../Add_A_Deck/styled_componets';
...
const AddCard = ({ rootNavigation, rootRoute, navigation, dispatch, route }) => {
	...
	return (
		<AddDeckWrapper>
			...
			<DeckTitleInput placeholder="Question" value={question} onChangeText={(val) => handleQuestion(val)} />
			<DeckTitleInput placeholder="Answer" value={answer} onChangeText={(val) => handleAnswer(val)} />
			<BtnContainer>
