...
import { removeFromDeck } from '../../store/actions/decks';
import { Loading } from '../Loading';

const ViewDeck = ({ rootNavigation, deck, rootRoute, navigation, dispatch, loading }) => {
	...
	return (
		<ContentWrapperCenter>
			<ContentTextWrapperCenter>
				...
				<View style={{ margin: 20 }}>
					<Button color="black" onPress={() => removeDeck(deck.title)} title="Delete card" />
				</View>
			</ContentTextWrapperCenter>
		</ContentWrapperCenter>
	);
