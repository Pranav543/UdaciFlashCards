...
export const clearLocalNotification = () => {
	return AsyncStorage.removeItem(NOTIFICATIONS_STORAGE_KEY).then(Notifications.cancelAllScheduledNotificationsAsync);
};
...
export const setLocalNotifications = async () => {
	const data = JSON.parse(await AsyncStorage.getItem(NOTIFICATIONS_STORAGE_KEY));
	if (data === null) {
